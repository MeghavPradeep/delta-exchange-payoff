...
/*
 * The three rules the analyse screen adds. `docs/payoff-contract.md`.
 *
 * They are here rather than in the components for this file's own reason: a number
 * becoming text is one subject, and it is where the correctness rules about absence and
 * zero are enforceable in one place instead of five.
 */

/**
 * A figure that may have been through the per-contract multiplier.
 *
